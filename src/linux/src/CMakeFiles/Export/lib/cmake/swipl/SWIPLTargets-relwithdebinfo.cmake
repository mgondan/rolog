...
set_target_properties(swipl::libswipl PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/swipl/lib/x86_64-linux/libswipl.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS swipl::libswipl )
list(APPEND _IMPORT_CHECK_FILES_FOR_swipl::libswipl "${_IMPORT_PREFIX}/lib/swipl/lib/x86_64-linux/libswipl.a" )
