...
# return value is TRUE (query successfully created), with an attribute
# that shows the prolog representation of the query
query(call("member", 
...
query(call("member", expression(X), list(1:3, 4:6)),
      options=list(intvec="%%"))
@
