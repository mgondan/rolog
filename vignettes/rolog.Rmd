...
and `postproc/2`. It illustrates that complicated syntax on the R side can be
considerably simplified when conversion is done at the Prolog end.
...
Rolog is a source package that requires R 4.2 and the RTools 4.2 toolchain under
Windows. Binaries will be made available soon on https://cran.r-project.org/.
